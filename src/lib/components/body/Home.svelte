<script>
    let content_p1 = `
    Hi, I'm Mihir, a junior at Ashoka University. I'm currently pursuing a major in Economics and a minor in Computer Science - an intersection I'm quite intrigued by.
    `
    let content_p2 = `
